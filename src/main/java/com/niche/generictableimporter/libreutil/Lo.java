...
public class Lo
{
  ...
  private static String libExeFolder = "C:/Program Files/LibreOffice/program";
...
*/
	...
	public static String getLibExeFolder() {
		return libExeFolder;
	}
	
	public static void setLibExeFolder(String libExeFolder) {
		Lo.libExeFolder = libExeFolder;
	}
  ...
  */
  {
	...
	//                    javaunohelper/com/sun/star/comp/helper/Bootstrap.java
	{
		...
		try {
			...
			xcc = BootstrapSocketConnector.bootstrap(libExeFolder);
